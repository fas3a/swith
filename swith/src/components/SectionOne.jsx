    ...
    <div className='sectionone px-4'>
      ...
      <nav className='navbar py-4 row'>
        ...
        <form className='justify-content-center d-flex col-md-6 bg-white py-1'>
          <input
            type='search'
            className='form-control py-1 px-2 pill search border-0'
            placeholder='Search for the product here!!'
          />
          <div className='btn btn-sm'>
            <AiOutlineSearch size='1.5em' color='black' />
          </div>
        </form>
      ...
      <div className='row mt-4'>
        <div className='col-md-3'>
          <h6
            className='rounded-pill text-center p-2 fs-6'
            style={{ backgroundColor: '#785D42' }}
          >
            POPULAR CATERGORIES
          </h6>
        </div>
      ...
      <div className='row my-1'>
        <div className='col-md-3'>
          <div className='nav text-white popular-categories px-1 flex-column'>
            <a href='' className='nav-link text-white border-bottom'>
              Men’s Fashion
            </a>
            <a href='' className='nav-link text-white border-bottom'>
              Women’s Fashion
        ...
        {/* Product you will like section */}
        <div
          className='col-md-6 hot-deal px-1 '
          style={{ borderRadius: '10px' }}
        >
          <div className='row'>
            <h1
              className='text-black col-md-4 fs-3 pt-4 ps-4'
              style={{ color: '#412519' }}
            >
              We have all the devices you are looking for here
            </h1>
          </div>
        </div>
